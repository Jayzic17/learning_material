...
const (
	...
	// VERY IMPORTANT: Go uses the capitilization of the first letter of variables to determine variable scope,
...
// ...Same goes for functions where capitilization of the first letter of functions determines function scope
func SayHi() {
	fmt.Println("Hi")
}
